    ...
    >
      ...
      >
        <input
          ...
          :value="
            partialProduct1Fields[partialProduct1Fields.length - 1 - index]
          "
          type="text"
          inputmode="numeric"
          pattern="[0-9]*"
          ...
          @beforeinput="
            (e) =>
              handlePartialProduct1Input(
                e,
                partialProduct1Fields.length - 1 - index,
              )
          "
          @keydown="
            (e) => handleKeydown(e, 1, partialProduct1Fields.length - 1 - index)
          "
          @click.stop="
            focusPartialProduct1(partialProduct1Fields.length - 1 - index)
          "
          @focus="handleFocus"
          @blur="emit('blur')"
        />
    ...
    >
      ...
      >
        <input
          ...
          :value="
            partialProduct2Fields[partialProduct2Fields.length - 1 - index]
          "
          type="text"
          inputmode="numeric"
          pattern="[0-9]*"
          ...
          @beforeinput="
            (e) =>
              handlePartialProduct2Input(
                e,
                partialProduct2Fields.length - 1 - index,
              )
          "
          @keydown="
            (e) => handleKeydown(e, 2, partialProduct2Fields.length - 1 - index)
          "
          @click.stop="
            focusPartialProduct2(partialProduct2Fields.length - 1 - index)
          "
          @focus="handleFocus"
          @blur="emit('blur')"
        />
    ...
    >
      ...
      >
        <input
          ...
          :value="
            partialProduct3Fields[partialProduct3Fields.length - 1 - index]
          "
          type="text"
          inputmode="numeric"
          pattern="[0-9]*"
          ...
          @beforeinput="
            (e) =>
              handlePartialProduct3Input(
                e,
                partialProduct3Fields.length - 1 - index,
              )
          "
          @keydown="
            (e) => handleKeydown(e, 3, partialProduct3Fields.length - 1 - index)
          "
          @click.stop="
            focusPartialProduct3(partialProduct3Fields.length - 1 - index)
          "
          @focus="handleFocus"
          @blur="emit('blur')"
        />
    ...
    >
      <div
        ...
        :class="{
          ...
          correct:
            showFeedback[multiplierDigits.length > 2 ? 4 : 3] &&
            finalAnswerCorrect,
          incorrect:
            showFeedback[multiplierDigits.length > 2 ? 4 : 3] &&
            !finalAnswerCorrect,
      ...
      >
        <input
          ...
          @beforeinput="
            (e) =>
              handleFinalAnswerInput(e, finalAnswerFields.length - 1 - index)
          "
          @keydown="
            (e) =>
              handleKeydown(
                e,
                multiplierDigits.length > 2 ? 4 : 3,
                finalAnswerFields.length - 1 - index,
              )
          "
...
const initializeFields = () => {
  ...
  const pp2Length =
    multiplierDigits.value.length > 1
      ? String(expectedPartialProduct2.value).length
      : 0;
  const pp3Length =
    multiplierDigits.value.length > 2
      ? String(expectedPartialProduct3.value).length
      : 0;
  ...
  if (props.showAnswers || isSolved) {
    ...
    partialProduct2Fields.value =
      pp2Length > 0 ? Array(pp2Length).fill("") : [];
    partialProduct3Fields.value =
      pp3Length > 0 ? Array(pp3Length).fill("") : [];
...
const updateCarryDigits = () => {
  ...
  for (let i = multiplicandStr.length - 1; i >= 0; i--) {
    ...
    const isFieldFilled =
      ...
      currentFields[fieldIndex] !== undefined;
    ...
    nextTick(() => {
      if (multiplierDigits.value.length > 1) {
        ...
        nextTick(() => {
          ...
          if (partialProduct2Refs.value[rightmost])
            partialProduct2Refs.value[rightmost].focus();
        });
      } else {
    ...
    nextTick(() => {
      if (multiplierDigits.value.length > 2) {
        ...
        nextTick(() => {
          ...
          if (partialProduct3Refs.value[rightmost])
            partialProduct3Refs.value[rightmost].focus();
        });
      } else {
        ...
        nextTick(() => {
          ...
          if (finalAnswerRefs.value[rightmost])
            finalAnswerRefs.value[rightmost].focus();
        });
      }
    });
  }
...
watch(
  () => [props.num1, props.num2, props.showAnswers],
  () => {
    initializeFields();
    nextTick(() => {

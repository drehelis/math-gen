<template>
  <div v-if="questions.length > 0">
    ...
    <div class="hidden print:block">
      <template v-for="(page, pageIndex) in paginateQuestions(questions, 30)" :key="`comparison-page-${pageIndex}`">
      ...
      <template v-if="showAnswers">
        <template v-for="(page, pageIndex) in paginateQuestions(questions, 30)" :key="`comparison-answer-page-${pageIndex}`">

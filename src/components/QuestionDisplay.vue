...
const useVerticalFormat = computed(
  () => props.difficulty === "medium" || props.difficulty === "hard",
);
...
const isMultiplication = (question: Question) => question.operation === "×";
const isAdditionOrSubtraction = (question: Question) =>
  question.operation === "+" || question.operation === "-";

const operatorMarginLeft = computed(() =>
  props.difficulty === "hard" ? "-0.8rem" : "-0.5rem",
);

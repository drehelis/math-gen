export const edgeCaseRules = [
  {
    operation: "division",
    check: (q) =>
      (q.operation === "÷" || q.operatorSymbol === "÷") && q.num1 === 0,
    key: "zeroDivision",
  },
  {
    operation: "division",
    check: (q) =>
      (q.operation === "÷" || q.operatorSymbol === "÷") && q.num2 === 1,
    key: "divideByOne",
  },
  {
    operation: "division",
    check: (q) =>
      (q.operation === "÷" || q.operatorSymbol === "÷") && q.num1 === q.num2,
    key: "oneDivision",
  },
  {
    operation: "multiplication",
    check: (q) =>
      (q.operation === "×" || q.operatorSymbol === "×") &&
      q.num1 === 0 &&
      q.num2 === 0,
  ...
  },
  {
    operation: "subtraction",
    check: (q) =>
      (q.operation === "-" || q.operatorSymbol === "-") && q.num2 === 0,
    key: "zeroSubtraction",
  },
  {
    operation: "subtraction",
